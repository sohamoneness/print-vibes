...
class DesignController extends BaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $this->setPageTitle('All Designs', 'List of all uploaded designs');
    ...
    public function store(Request $request)
    {
        ...
        return $this->responseRedirect('admin.design.index', 'Design added successfully' ,'success',false, false);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.design.edit', compact('targetDesign'));
    }
    ...
    public function delete($id)
    {
        ...
        return $this->responseRedirect('admin.design.index', 'Design has been deleted successfully' ,'success',false, false);
    }
