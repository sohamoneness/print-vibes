...
Route::post('/user/forgot/password/check', 'Api\UserController@forgotPasswordMobileNumberCheck');
Route::post('/user/forgot/password/update', 'Api\UserController@forgotPasswordUpdate');
...
Route::group(['middleware' => ['jwt.verify']], function() {
    ...
    Route::get('restaurant/coupons/{id}/{userId}', 'Api\RestaurantController@getActiveCoupons');

    Route::post('wallet/credit', 'Api\WalletController@walletCredit');
    Route::get('wallet/user/{userId}', 'Api\WalletController@userWallets');

    Route::post('delivery/charge', 'Api\CommonController@deliveryCharge');
});
...
Route::post('repeat-order', 'Api\CommonController@repeatOrder');
Route::post('search-item', 'Api\CommonController@searchItems');
Route::get('user/current/orders/{userId}', 'Api\CommonController@userCurrentOrders');
Route::get('all/coupons/{id}/{userId}', 'Api\RestaurantController@getAllActiveCoupons');
Route::post('check-active-coupon', 'Api\RestaurantController@checkActiveCoupon');
Route::post('claim-gift-requests', 'Api\CommonController@claimGiftRequests');
Route::get('home-screen-data-user', 'Api\CommonController@fetchHomeScreenDataWithUser');
Route::get('order/invoice/{userId}', 'Api\OrderController@invoice');
Route::post('order-date-filter', 'Api\OrderController@filterOrderByDate');
Route::get('all-active-coupons-web/{restaurantId}/{userId}', 'Api\RestaurantController@getAllCouponsWeb');
Route::get('get-user-offer-web/{userId}', 'Api\RestaurantController@getOffersForWeb');
...
Route::post('restaurant-ready-order', 'Api\RestaurantManagementController@readyOrder');
Route::post('restaurant-dispatch-order', 'Api\RestaurantManagementController@dispatchOrder');
Route::post('restaurant-extra-time', 'Api\RestaurantManagementController@extraTimeOrder');
Route::post('restaurant-open-close', 'Api\RestaurantManagementController@restaurantOpenClose');
Route::get('restaurant/stock/update/{id}/{status}', 'Api\RestaurantManagementController@stockUpdate');
...
Route::post('boy/earnings', 'Api\DeliveryBoyManagementController@earnings');
...
Route::get('boy/logout/{id}', 'Api\DeliveryBoyManagementController@logout');
Route::post('boy-location-update', 'Api\DeliveryBoyManagementController@updateDriverLocation');
Route::post('cod-paytype-update', 'Api\DeliveryBoyManagementController@codPaytypeUpdate');