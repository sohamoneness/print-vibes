...
@php
$today = date("Y-m-d");
$artist_id = Auth::guard('admin')->user()->id;
$total_visitors = App\Models\Visitor::get();
$today_visitors = App\Models\Visitor::where('created_at','like',$today.'%')->get();
$total_orders = App\Models\UserTransaction::get();
$today_orders = App\Models\UserTransaction::where('created_at','like',$today.'%')->get();
$total_sales = App\Models\UserTransaction::sum('commission_amount');
$today_sales = App\Models\UserTransaction::where('created_at','like',$today.'%')->sum('commission_amount');
$total_followers = App\Models\Follower::with('followed_by')->get();
$total_designs = App\Models\Design::get();
