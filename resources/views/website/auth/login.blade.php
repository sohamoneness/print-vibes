...
<html lang="en">
  ...
  <body class="details___main__body">
      ...
      <header class="header">
        <nav>
          <div class="container-fluid">
            ...
            <div class="logo">
              <a href="index.html">
                <img src="{{asset('website/website/images/logo.png')}}" alt="" class="img-fluid" />
              </a>
            </div>
            <div class="search">
              <form action="">
 ...
 @endphp
            ...
            <div class="col-sm-5 my-5">
              <form class="mt-4" action="{{ route('login.post') }}" method="POST">
                @csrf
                    ...
                    <p class="text-center">Please enter your login details to access your account.</p>

                    <div class="form-group">
                        <a href="{{route('artist.login')}}" class="btn btn-pink btn-block">Login as artist</a>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row justify-content-between">
                            <div class="col-auto"><label>Password</label></div>
                            <div class="col-auto"><a href="#">Forgot Password?</a></div>
                        </div>
                    ...
                    <p class="text-center">By clicking Log In, you agree to our User Agreement</p>
                    <div class="form-group">
                        <button type="submit" class="btn btn-theme btn-block">Login</button>
                    </div>
                    <p class="text-center">Need an account? <a href="{{route('register')}}">Sign Up</a></p>
                </form>
            </div>
        </div>
    </section>
    ...
    <script type="text/javascript">
      ...
      $(".related_slider").slick({
        ...
        arrows: true,
        nextArrow:
          '<button class="slider_arrow_right"><img class="img-fluid" src="{{asset("website/images/slider-right-arrow.svg")}}"></button>',
        prevArrow:
          '<button class="slider_arrow_left"><img class="img-fluid" src="{{asset("website/images/slider-left-arrow.svg")}}"></button>',
        responsive: [
          {
            breakpoint: 768,
            settings: {
